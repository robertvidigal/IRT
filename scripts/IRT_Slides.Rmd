...
$$
--
```{r apsr, echo=F, fig.align='center'}
knitr::include_graphics("~/Documents/IRT-Workshop/figs/APSR.png") 
```
---
# O que é IRT?
...
```{r 1pl-a, echo=F, fig.align='center', out.width='75%'}
knitr::include_graphics("~/Documents/IRT-Workshop/figs/1PL.png") 
```
...
---
# 1-Parameter Logistic Model
```{r 1pl-aa, echo=F, fig.align='center'}
knitr::include_graphics("~/Documents/IRT-Workshop/figs/1PL.png") 
```
...
---
# 1-Parameter Logistic Model
```{r 1pl-aaa, echo=F, fig.align='center'}
knitr::include_graphics("~/Documents/IRT-Workshop/figs/1PL.png") 
```
...
---
# 1-Parameter Logistic Model
```{r 1pl-aaaa, echo=F, fig.align='center'}
knitr::include_graphics("~/Documents/IRT-Workshop/figs/1PL.png") 
```
...
```{r 1pl-rash, echo=F, fig.align='center', out.width = '55%'}
knitr::include_graphics("~/Documents/IRT-Workshop/figs/1pl-rash.png") 
```
--
...
```{r 1pl-rash2, echo=F, fig.align='center', out.width = '55%'}
knitr::include_graphics("~/Documents/IRT-Workshop/figs/1pl-rash.png") 
```
...
```{r diff, echo=F, fig.align='center', out.width = '65%'}
knitr::include_graphics("~/Documents/IRT-Workshop/figs/difficulty.png") 
``` 
--
...
```{r 2PL, echo=F, fig.align='center', out.width = '45%'}
knitr::include_graphics("~/Documents/IRT-Workshop/figs/2PL.png") 
``` 
???
...
---
# 3-parameter logistic model
Para determinar a função de resposta de adivinhação pseudoaleatória, precisamos considerar CHI_j e a probabilidade
...
- Quando uma pessoa é bem-sucedida no item **j** com base apenas no acaso (**p_j**=0), a probabilidade é igual à resposta de adivinhação pseudoaleatória (**CHI_j**).
...
- Teste de **Mantel-haenszel** (MH) para detecção de DIF uniforme
  ...
  - O continuum de habilidades, definido pelas pontuações totais do teste, é dividido em **k** intervalos discretos que servem de base para a correspondência entre os membros de ambos os grupos.
...
???
In this case, p_i is the probability of endorsing the item, or a correct response, 
Score_i is the score on the total scale leaving out the item being assessed for DIF, 
and group is the grouping variable (e.g. gender). 

The coefficient β2 provides the estimate of uniform DIF, 
and when significantly different from zero indicates the presence of such. 

Likewise, β3 is the estimate of nonuniform DIF.
...
- R, R Markdown, Data Science e mais: https://bookdown.org/
